...
/**
 * Input DTO para valor temporal de parâmetro tributário.
 *
 * <p>Representa um período (mensal ou trimestral) em que um parâmetro tributário está ativo.
 *
 ...
 */
public record TemporalValueInput(
